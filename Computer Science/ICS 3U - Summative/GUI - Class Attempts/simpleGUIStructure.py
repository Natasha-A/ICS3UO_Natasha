...
class MyFirstGUI:
    def __init__(self, master):
        ...
        # label doesn't do anything by default, only waits to display something
...
# binding allows us to dynamically adjust a event by creating a new functionality for it to follow
